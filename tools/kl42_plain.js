/* KL42 沙中藏贝 —— 前端明文签名脚本（混淆原料，真源文件）
 * 被 tools/gen_kl42.py 读取：先 javascript-obfuscator 混淆，再 RC4 包进 assets/h5/vault_kl42.bin。
 * 明文仅供本地生成/自警使用，绝不进 APK。
 */
(function () {
  var SECRET = "Fatdog_reef"; // 前端签名密钥（真钥）
  ...
  function fdSign(page, ts) {
    return hmacSha256Hex(SECRET, "page=" + page + "&ts=" + ts);
  }

  if (typeof window !== "undefined") { window.fdSign = fdSign; }
  if (typeof module !== "undefined" && module.exports) { module.exports = { fdSign: fdSign }; }
})();
