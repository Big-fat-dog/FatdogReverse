...
public class p45Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("S 盒 d6 90 e9 fe 认得出 SM4，FK 也是标准——可标准库怎么解都是乱码。\n"
                + "骨架没错的话，被动手脚的就是轮常量 CK 的尾部。密文就在请求参数里。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(p45Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(p45Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(p45Activity.this)
                        .setTitle("提示")
        ...
        box.addView(Ui.banner(this, R.drawable.level_kl8, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(p45Activity.this, "FLAG_18_KL8{spring_eye_awake}");
                    PassLog.mark(p45Activity.this, "KL8");
                } else {
                    Toast.makeText(p45Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Wr.fetchPage(base, page, new Wr.Cb() {
            @Override
