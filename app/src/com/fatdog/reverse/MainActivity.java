...
public class MainActivity extends Activity {
    ...
    private static final String[] CATS = {"静态分析", "Smali 挑战", "Frida Hook（Java 层）", "Xposed 实战", "网络对抗", "SSL 抓包", "Native 试炼", "签名校验对抗", "Native大陆"};
    ...
    private void bindLevelButtons() {
        ...
        bind(R.id.btn_l48, x48Activity.class);
    ...
    private View buildKunlunList() {
        ...
        if (kunlunCat == 0) {
            ...
            Class<?>[] kklTargets = {kkl1Activity.class, kkl2Activity.class, kkl3Activity.class, kkl4Activity.class, kkl5Activity.class};
