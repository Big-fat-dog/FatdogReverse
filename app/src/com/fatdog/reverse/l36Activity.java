...
public class l36Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("这一关的 so 里躺着一串像乱码的字符——结尾还有两个等号。\n"
                + "老规矩：先想 Base64。解开它就是手写 AES-128 的真钥匙。认算法靠 S 盒 63 7c 77 7b…");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(l36Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(l36Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        box.addView(Ui.banner(this, R.drawable.level_36, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(l36Activity.this, "FLAG_18_L36{base64_is_not_encryption}");
                    PassLog.mark(l36Activity.this, "L36");
                } else {
                    Toast.makeText(l36Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Nn.fetchPage(base, page, new Nn.Cb() {
            @Override
