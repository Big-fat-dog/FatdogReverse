...
public class r47Activity extends Activity {
    static final String SUM_HASH = "6f18896aa93c4f02dfdf5d4109d29841e4c381a4383a23830b9e997c453fb4cf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("收官卷：K 表认得出 SHA256、S 盒认得出 AES——可两层都被动过手脚。\n"
                + "一层一层剥：先看摘要初始化和填充边界，再看列混合的系数。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(r47Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(r47Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(r47Activity.this)
                        .setTitle("提示")
        ...
        box.addView(Ui.banner(this, R.drawable.level_kl10, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(r47Activity.this, "FLAG_18_KL10{myriad_as_one}");
                    PassLog.mark(r47Activity.this, "KL10");
                } else {
                    Toast.makeText(r47Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Zx.fetchPage(base, page, new Zx.Cb() {
            @Override
