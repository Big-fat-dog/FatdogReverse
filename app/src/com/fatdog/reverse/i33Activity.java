...
public class i33Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("这一关的 so 会给自己做\"体检\"：加载时算一遍自身代码的 CRC，之后每次签名都复查。\n"
                + "连只观察不修改的钩子都会被逮住——除非你抢在体检之前完成伪装。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(i33Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(i33Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        box.addView(Ui.banner(this, R.drawable.level_33, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(i33Activity.this, "FLAG_18_L33{crc_guard_bypassed}");
                    PassLog.mark(i33Activity.this, "L33");
                } else {
                    Toast.makeText(i33Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Gi.fetchPage(base, page, new Gi.Cb() {
            @Override
