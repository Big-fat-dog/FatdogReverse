...
public class ForbiddenLandActivity extends Activity {
    private static final String[] LEVEL_IDS = {
            ...
            "L17", "L18", "L19", "L20", "L21", "L22", "L23", "L24", "L25", "L26", "L27", "L28", "L29", "L30", "L31", "L32", "L33", "L34", "L35", "L36", "L37", "L38", "L39", "L40", "L41", "L42", "L43", "L44", "L45", "L46", "L47", "L48", "L49", "L50", "L51", "L52", "L53"};
    private static final String[] LEVEL_NAMES = {
            ...
            "第 24 层", "第 25 层", "第 26 层 · 双符合璧", "第 27 层 · 万法归宗", "第 28 层 · 缄默之钥", "第 29 层 · 隐姓埋名", "第 30 层 · 无名剑冢", "第 31 层 · 两界穿针", "第 32 层 · 心魔哨兵", "第 33 层 · 金刚不坏", "第 34 层 · 万法归墟", "第 35 层 · 双匣暗渡", "第 36 层 · 查表识君", "第 37 层 · 雪崩之谜", "第 38 层 · 初探模块", "第 39 层 · 偷梁换柱", "第 40 层 · 探囊取物", "第 41 层 · 斩关夺隘", "第 42 层 · 万剑归宗", "第 43 层 · 照妖之镜", "第 44 层 · 偷天换日",             "第 45 层 · 移形换影", "第 46 层 · 以签为钥", "第 47 层 · 幽冥合卷", "第 48 层 · 落日平原", "第 49 层 · 迷雾森林", "第 50 层 · 幽暗深渊", "第 51 层 · 雷霆山巅", "第 52 层 · 冰封雪域", "第 53 层 · 焚天火域"};
