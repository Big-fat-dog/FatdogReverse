...
public class ForbiddenLandActivity extends Activity {
    ...
    private static final String[] LEVEL_NAMES = {
            ...
            "第 24 层", "第 25 层", "第 26 层 · 双符合璧", "第 27 层 · 万法归宗", "第 28 层 · 缄默之钥", "第 29 层 · 隐姓埋名", "第 30 层 · 无名剑冢", "第 31 层 · 两界穿针", "第 32 层 · 心魔哨兵", "第 33 层 · 金刚不坏", "第 34 层 · 万法归墟", "第 35 层 · 双匣暗渡", "第 36 层 · 查表识君", "第 37 层 · 雪崩之谜"};
