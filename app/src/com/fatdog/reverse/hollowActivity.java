...
// 天地秘境·太玄之初 KL17「金蝉脱壳」：仿 360 加固保·二代壳（类抽取，运行时回填）。
// 取数链路与网络数字求和一致：Ek 在 so(JNI_OnLoad 把 4 段回填拼出真标记) 里用标准
// HMAC-SHA256（钥匙由标记派生）给 "page=N&ts=T" 签名，带签请求 /api/kl17 取数后求和。
public class hollowActivity extends Activity {
    static final String SUM_HASH = "cfb56f84db84b46d25b59a25b377c141c240492dea7520b65dc8a622ca5143b5";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("壳把类里的内容抽空了，只在跑起来的那一刻才一段段填回去。\n"
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(hollowActivity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(hollowActivity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(hollowActivity.this)
                        .setTitle("提示")
                        .setMessage("第二代加固会把类里的内容抽空，等跑起来时再由 native 一段一段填回去——"
                                + "所以静态翻到的那个形近串，未必就是真正生效的那一个。\n\n"
                                + "填回去之后，才由那段内容派生出给请求签名的钥匙："
                                + "标准 HMAC-SHA256，签名对象是页码与时间戳。\n\n"
                                + "别指望在静态字符串里找到完整答案——让它真正跑起来，"
                                + "或者在它回填的那一刻把它截下来。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_kl17, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(hollowActivity.this, "FLAG_18_KL17{class_refilled}");
                    PassLog.mark(hollowActivity.this, "KL17");
                } else {
                    Toast.makeText(hollowActivity.this,
    ...
    private void loadPage(final int page) {
        ...
        Ek.fetchPage(base, page, new Ek.Cb() {
            @Override
