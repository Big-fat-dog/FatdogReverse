...
// 网络关卡 16（对应教程 20/RC4）：流密码暗河——数据只在本地服务端，分页加载。
public class t6Activity extends Activity {
    static final String SUM_HASH = "0fc0c0f3150a0bcfc92406bdbbc565a336499c39a79a3a5e430d096cbc740ac2";
    static final int PAGES = 60;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("服务端有 60 页、每页 8 个数字。\n请求参数整段 RC4 加密 + MD5 签名，响应体另一把 RC4 密钥加密，分页取回后求和提交。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(t6Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(t6Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(t6Activity.this)
                        .setTitle("提示")
                        .setMessage("payload 是 RC4 密文，sig 是 MD5(payload+盐)。三把密钥素材拆在 Jk/C16 的异或数组里，先用 Python 手写 RC4 逐页取数求和。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_16, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(t6Activity.this, "FLAG_18_L16{rc4_stream_encrypted}");
                    PassLog.mark(t6Activity.this, "L16");
                } else {
                    Toast.makeText(t6Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        C16.fetchPage(base, page, new C16.PageCallback() {
            @Override
