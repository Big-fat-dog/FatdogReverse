...
// 碧落天 KL40「星河倒影」：综合收官卷。
// 取数链路是网络求和：请求被 GCM 封住并附 MD5 摘要，回来的数字又被**换了一把钥**锁了一遍——
// 三道关都过了，数字才落到手里。
public class reflectActivity extends Activity {
    static final String SUM_HASH = "82f73d7c8cedfa21aaccd6df5d3a3e82445cbdb791a6a03b26b7b8d848ff4f40";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("星河落进水里，倒影比星星多了一层。\n"
                + "去时封了三道，回来又换了一把锁；\n"
                + "只有看清全貌的人，才数得清湖底的光。");
        tv.setGravity(Gravity.CENTER);
        box.addView(tv, Ui.wrap(4));

        // 只读自检：只报密码原语与检测评分，不吐密钥、不判胜
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(reflectActivity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(reflectActivity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(reflectActivity.this)
                        .setTitle("提示")
                        .setMessage("这一关把前面几关的手艺都叠在了一起：\n\n"
                                + "· 去的时候用 GCM 封（密文后面还缀着一截校验标签，改一个字节就不认）；\n"
                                + "· 附上一句普通 MD5 摘要做凭据；\n"
                                + "· 回来的数字**换了一把钥**（CBC，前 16 字节是偏移），得解一次才看得见。\n\n"
                                + "钥匙都由同一个标记派生，但请求与响应各用各的。\n"
                                + "把前三步都摸清，剩下的只是耐心。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_kl40, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    ...
                    Toast.makeText(reflectActivity.this,
    ...
    private void refreshGuard() {
        try {
            guard.setText("算法自检：" + FlutterMirror.nativeGetStatus());
        } catch (Throwable t) {
    ...
    private void loadPage(final int page) {
        ...
        FlutterMirror.fetchPage(base, page, new FlutterMirror.Cb() {
            @Override
