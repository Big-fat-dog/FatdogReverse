...
// 网络关卡 25（对应教程 22 预告/native 校验 JNI）：门禁与签名都在 libnative.so 里，
// jadx 里只有 JNI 声明，Java 层 Hook 无效。数据只在本地服务端，分页加载。
public class a25Activity extends Activity {
    static final String SUM_HASH = "9489b1bd3adaef30cc26c800da6979c2052cb3bdb26c4ff7dba42d7407753685";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("这一关的校验不在 Java 里——门禁和签名都搬进了 libnative.so。\njadx 里只有两行 JNI 声明，Java Hook 抓不到签名。100 页 × 每页 10 个，分页取回求和。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(a25Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(a25Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(a25Activity.this)
                        .setTitle("提示")
                        .setMessage("服务端 HTTPS:8443 的 /api/native（NetHost 自动选主机）。App 发请求前调 Nx.verifyServer（native 主机白名单），签名 Nx.nativeSign 在 C 里算 HMAC-SHA256——密钥不在 Java，Hook Mac/MessageDigest 没用。\n正路：把 APK 里 lib/arm64-v8a/libnative.so 解出来，strings 找密钥（fatdemo_jni_2026），Python 带 certs/ca.crt 复刻取数；或 Frida 原生层：Interceptor.attach 观察、NativeFunction 直接调 nativeSign。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_25, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(a25Activity.this, "FLAG_18_L25{native_jni_verify}");
                    PassLog.mark(a25Activity.this, "L25");
                } else {
                    Toast.makeText(a25Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        By.fetchPage(base, page, new By.Cb() {
            @Override
