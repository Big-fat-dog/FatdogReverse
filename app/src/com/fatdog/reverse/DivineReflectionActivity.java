...
public class DivineReflectionActivity extends Activity {
    ...
    private static final String[] NAMES = {
            ...
            "乾坤迷阵", "虚空造化", "破壁飞升", "枯叶听风", "落影寻痕", "照妖显形", "冰鉴悬镜",          "暮雾锁听", "暮霭沉沉", "轻纱覆影", "雪落无痕", "暗流涌动", "天机织锦",             "玄冥渊", "万剑冢", "断魂谷", "锁妖塔","诛仙台", "云中锦书", "风中鸢尾", "雾里观花",             "落日平原", "迷雾森林", "幽暗深渊", "雷霆山巅", "冰封雪域", "焚天火域"};
