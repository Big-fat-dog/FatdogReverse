...
public class DivineReflectionActivity extends Activity {
    public static final String[] LEVEL_IDS = {
            ...
            "L17", "L18", "L19", "L20", "L21", "L22", "L23", "L24", "L25", "L26", "L27", "L28", "L29", "L30", "L31", "L32", "L33", "L34", "L35", "L36", "L37", "KL1", "KL2", "KL3", "KL4", "KL5", "L38", "L39", "L40", "L41", "L42"};
    private static final String[] NAMES = {
            ...
            "双龙出海", "三才归一", "隔空取物", "逆流断脉",
            "奇门暗渡", "双钥破天", "雾隐摘星", "广告心魔",
            "偷天换日", "拔钉破罩", "拨云见日", "李代桃僵", "玄功夺舍", "双符合璧", "万法归宗", "天地噤声", "匿迹遁形", "剑冢寻锋", "两界拈针", "万蛊不侵", "万劫金身", "一念归墟", "双匣藏锋", "洞玄辨纹", "雪崩千里", "叩山门", "掌雷针", "渡鸦引", "裂冰诀", "踏虚步", "傀儡线", "偷天换玉"};
    private static final String[] DESCS = {
            ...
            "渡鸦引：跨界取钥一线牵",
            "裂冰诀：假文件破冰面",
            "踏虚步：五法归一登绝顶", "摘星拿月", "断岳斩", "万剑归宗"};
    private static final String[] CAT_NAMES = {
            "静态分析 · 观物之能", "Smali 挑战 · 篡改之道", "Frida Hook · 附身之术", "网络对抗 · 取数之法", "终极试炼 · 破阵之威", "Native 试炼 · 破壁之术", "天地秘境 · 登天之路"};
    private static final int[] CAT_COLORS = {0xFF409EFF, 0xFF67C23A, 0xFFFB7299, 0xFFE6A23C, 0xFFB37FEB, 0xFF00BFA5, 0xFFFF6D3B};
