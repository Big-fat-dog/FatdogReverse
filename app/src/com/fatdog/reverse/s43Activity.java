...
public class s43Activity extends Activity {
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(s43Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(s43Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void loadPage(final int page) {
        ...
        Vk.fetchPage(base, page, new Vk.Cb() {
            @Override
