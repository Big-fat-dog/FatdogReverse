...
// 迷阵 KL53「移形换位」：OLLVM 字符串加密。
// 取数链路是网络求和：libshift.so 把标记和密钥都换成了密文，
// 藏在加载的各个环节，运行时才悄悄还原。
// 认不出那些"被换走的字"，就复刻不了签名。
public class shiftActivity extends Activity {
    static final String SUM_HASH = "2a9de50e2a9e93478510d172e6a9e3527c7ca5764181f58f28554425494af6a1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(shiftActivity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(shiftActivity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(shiftActivity.this)
                        .setTitle("提示")
                        .setMessage("名字和钥匙，都被一层薄薄的迷障盖住了，\n"
                                + "乍看是一串读不懂的数，其实每个都差着同一个数。\n\n"
                                + "这些字不是一开始就醒着的——有的在进门时就醒，\n"
                                + "有的要等你喊一声才醒。\n"
                                + "想看见真字，要么在它醒来的那一刻截住它，\n"
                                + "要么照着那层迷障的规矩，自己把它还原。\n\n"
                                + "真字一现，密文和落款自然就明白了。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_kl53, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(shiftActivity.this, "FLAG_18_KL53{form_shifted_position}");
                    PassLog.mark(shiftActivity.this, "KL53");
                } else {
    ...
    private void loadPage(final int page) {
        ...
        StringGuard.fetchPage(base, page, new StringGuard.Cb() {
            @Override
