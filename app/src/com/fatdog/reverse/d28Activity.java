...
public class d28Activity extends Activity {
    static final String SUM_HASH = "f80a085589b42f10ddb23cb80faa8f9791ad70cb2644b4cca7b71204ac4c0882";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(d28Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(d28Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        box.addView(Ui.banner(this, R.drawable.level_28, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(d28Activity.this, "FLAG_18_L28{runtime_decoded_key}");
                    PassLog.mark(d28Activity.this, "L28");
                } else {
                    Toast.makeText(d28Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Ct.fetchPage(base, page, new Ct.Cb() {
            @Override
