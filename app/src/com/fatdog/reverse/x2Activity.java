...
// 网络关卡 22（对应教程 20/OkHttp CertificatePinner）：OkHttp 证书锁定——数据只在本地服务端，分页加载。
public class x2Activity extends Activity {
    static final String SUM_HASH = "ffaaef0d1260faffeab53f3f91c131dcfcdf94643842fa821ffaea11968e4fa1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("信任校验只是第一道门——这关把服务器证书又焊死了一层。\n抓包要过两道闸，100 页 × 每页 10 个，分页取回求和。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(x2Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(x2Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(x2Activity.this)
                        .setTitle("提示")
                        .setMessage("走 HTTPS :8443 的 /api/pin（主机由 NetHost 自动选：模拟器 10.0.2.2 / 真机 127.0.0.1），HMAC 密钥前段 Kp、后段 Pn。抓包需 Hook checkServerTrusted + CertificatePinner.check，或静态找密钥带 CA 复刻。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_22, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(x2Activity.this, "FLAG_18_L22{okhttp_certificate_pinner}");
                    PassLog.mark(x2Activity.this, "L22");
                } else {
                    Toast.makeText(x2Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Pn.fetchPage(base, page, new Pn.Cb() {
            @Override
