...
// 网络关卡 17（对应教程 20/SM4+SM3）：国密表单——数据只在本地服务端，分页加载。
public class u7Activity extends Activity {
    static final String SUM_HASH = "2229e2b2b7f7d6f8c7bc3e5bedb2037bf3ca51498635f3e691269e6dd17d2c64";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("服务端有 100 页、每页 10 个数字。\nPOST 表单里有一堆参数，真正被校验的只有 enc/sig/dog/ts，分页取回后求和提交。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(u7Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(u7Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(u7Activity.this)
                        .setTitle("提示")
                        .setMessage("表单里 enc=SM4 加密、sig=SM3 摘要、dog=fatdog；SM4/SM3 是手写实现，密钥/盐拆在 Kt/Fl 的异或数组里，复刻逐页取数。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_17, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(u7Activity.this, "FLAG_18_L17{sm4_sm3_form}");
                    PassLog.mark(u7Activity.this, "L17");
                } else {
                    Toast.makeText(u7Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Fl.fetchPage(base, page, new Fl.PageCallback() {
            @Override
