...
// 网络关卡 18（对应教程 20/RSA+DES）：RSA 表单 + DES 响应——数据只在本地服务端，分页加载。
public class v8Activity extends Activity {
    static final String SUM_HASH = "48bad9686aadcf563b9c294eb547f6bc3c5f999a994be89bb97662f1cd664883";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("服务端有 100 页、每页 10 个数字。\n请求参数加密，响应体也要解密；密钥一半由服务端下发、一半藏在 App，分页取回后求和提交。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(v8Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(v8Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(v8Activity.this)
                        .setTitle("提示")
                        .setMessage("先 GET /api/dskey 拿 DES 密钥前半段，再 POST /api/rsa 用 RSA-1024 加密 page=N&ts=T。公钥与 DES 后半段在 Pk（异或数组）。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_18, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(v8Activity.this, "FLAG_18_L18{rsa_des_form}");
                    PassLog.mark(v8Activity.this, "L18");
                } else {
                    Toast.makeText(v8Activity.this,
                            "加和不对，再取数算一遍。", Toast.LENGTH_SHORT).show();
                }
            }
        });

        status.setText("正在向服务端获取 DES 密钥…");
        Rs.init(base, new Rs.InitCallback() {
            @Override
            public void onReady() {
    ...
    private void loadPage(final int page) {
        ...
        Rs.fetchPage(base, page, new Rs.PageCallback() {
            @Override
