...
import com.fatdog.reverse.o.Api;
...
// 网络关卡 19（对应教程 20/AES+HMAC+R8混淆）：AES+HMAC（混淆）——数据只在本地服务端，分页加载。
public class v9Activity extends Activity {
    static final String SUM_HASH = "71fdbf511fc9416fc8c1702684e4daeec70388d6d2e20d56442a056d74661214";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("服务端有 100 页、每页 10 个数字。\n请求参数加密 + 签名，响应体也要解密；加密相关类被混淆，分页取回后求和提交。");
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    else Toast.makeText(v9Activity.this, "页码超出范围 1-" + PAGES, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(v9Activity.this, "请输入页码", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(v9Activity.this)
                        .setTitle("提示")
                        .setMessage("加密逻辑在 o 包，R8 混淆成单字母类；算法名/路径/密钥均异或加密字符串。先还原 o.Keys 三把密钥，再复刻 AES-ECB+HMAC 逐页取数。")
        ...
        box.addView(Ui.banner(this, R.drawable.level_19, 150));
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sha256Hex(ans).equals(SUM_HASH)) {
                    Celebration.show(v9Activity.this, "FLAG_18_L19{obfuscated_aes_hmac}");
                    PassLog.mark(v9Activity.this, "L19");
                } else {
                    Toast.makeText(v9Activity.this,
    ...
    private void loadPage(final int page) {
        ...
        Api.fetchPage(base, page, new Api.Cb() {
            @Override
