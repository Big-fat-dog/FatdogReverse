...
public:
    static std::string getAesKey() {
        // Fatdog_abys_2026 (XOR ^0x2A, 16 bytes)
        static const uint8_t raw[] = {
            0x46 ^ 0x2A, 0x61 ^ 0x2A, 0x74 ^ 0x2A, 0x64 ^ 0x2A, 0x6F ^ 0x2A,
            0x67 ^ 0x2A, 0x5F ^ 0x2A, 0x61 ^ 0x2A, 0x62 ^ 0x2A, 0x79 ^ 0x2A,
            0x73 ^ 0x2A, 0x5F ^ 0x2A, 0x32 ^ 0x2A, 0x30 ^ 0x2A, 0x32 ^ 0x2A,
            0x36 ^ 0x2A, 0x00
        };
